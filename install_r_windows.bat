...
) else if exist "C:\Users\%USERNAME%\AppData\Local\R\R-4.4.3\bin\R.exe " (
    echo Found R 4.4.3 in User AppData >> setup_log.txt
    set "R_PATH=C:\Users\%USERNAME%\AppData\Local\R\R-4.4.3\bin"
    set "R_FOUND=1"
    echo Found R 4.4.3 in Program Files x86 and added to PATH
) else (
...
if exist "C:\Program Files\RStudio\bin\rstudio.exe" (
    ...
    set "RSTUDIO_FOUND=1"
) else if exist "C:\Program Files\RStudio Desktop\bin\rstudio.exe" (
    echo RStudio found at C:\Program Files\RStudio Desktop\bin\rstudio.exe
    echo RStudio found at C:\Program Files\RStudio Desktop\bin\rstudio.exe >> setup_log.txt
    set "RSTUDIO_FOUND=1"
) else if exist "C:\Program Files (x86)\RStudio\bin\rstudio.exe" (
    echo RStudio found at C:\Program Files x86\RStudio\bin\rstudio.exe
    echo RStudio found at C:\Program Files x86\RStudio\bin\rstudio.exe >> setup_log.txt
    set "RSTUDIO_FOUND=1"
) else if exist "C:\Program Files (x86)\RStudio\rstudio.exe" (
    echo RStudio found at C:\Program Files x86\RStudio\rstudio.exe
    echo RStudio found at C:\Program Files x86\RStudio\rstudio.exe >> setup_log.txt
    set "RSTUDIO_FOUND=1"
) else if exist "C:\Program Files (x86)\RStudio Desktop\bin\rstudio.exe" (
    echo RStudio found at C:\Program Files x86\RStudio Desktop\bin\rstudio.exe
    echo RStudio found at C:\Program Files x86\RStudio Desktop\bin\rstudio.exe >> setup_log.txt
    set "RSTUDIO_FOUND=1"
) else (
...
if exist "C:\Program Files\RStudio\bin\rstudio.exe" (
    ...
    set "RSTUDIO_EXE=C:\Program Files\RStudio Desktop\bin\rstudio.exe"p
) else if exist "C:\Program Files (x86)\RStudio\bin\rstudio.exe" (
    set "RSTUDIO_EXE=C:\Program Files (x86)\RStudio\bin\rstudio.exe"
) else if exist "C:\Program Files (x86)\RStudio\rstudio.exe" (
    set "RSTUDIO_EXE=C:\Program Files (x86)\RStudio\rstudio.exe"
) else if exist "C:\Program Files (x86)\RStudio Desktop\bin\rstudio.exe" (
    set "RSTUDIO_EXE=C:\Program Files (x86)\RStudio Desktop\bin\rstudio.exe"
)

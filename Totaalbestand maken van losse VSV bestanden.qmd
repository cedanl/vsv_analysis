...
-   <u>Bronmap</u>: Vervang de drie puntjes in de regel `data_base_dir: "..."` met de **link naar de map** waarin de VSV-bestanden staan
-   <u>Doelmap</u>: Vervang de drie puntjes in de regel `data_results_dir: "..."` met de **link naar de map** waarin de resultaten naar toe gestuurd moeten worden
